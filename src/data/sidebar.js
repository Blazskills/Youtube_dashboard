import { Crown, FileCode, Heart, ListVideo, ShieldMinus } from "lucide-react";
...
export const playlists = [
  { id: "1", name: "Frontend & Backend", icon: ListVideo },
  { id: "2", name: "Favorites", icon: Heart },
  { id: "3", name: "React", icon: ShieldMinus },
  { id: "4", name: "Non-Dev", icon: Crown },
  { id: "5", name: "TypeScript", icon: FileCode },
];
